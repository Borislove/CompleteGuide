...
//Продемонстрировать применение лямбда-выражения, принимающего один параметр
...
public class LambdaDemo2 {
    public static void main(String[] args) {
        ...
        //А теперь воспользоваться лямбда-выражением, в котором проверяется, является ли число неотрицательным
